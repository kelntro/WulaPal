      ...
      {isProcessing ? (
        <div className="flex flex-col items-center bg-white shadow-lg rounded-2xl p-6 w-[1000px] h-[600px] max-w-full">
          ...
          <p className="text-lg text-gray-700 text-center mb-4 mb-[20px] mt-[-50px]">
            We are processing the transfer for you, hold on!
          </p>
        ...
        <div className="flex flex-col items-center bg-white shadow-lg rounded-2xl p-6 w-[1000px] h-[600px] max-w-full">
          ...
          <p className="text-lg text-gray-700 text-center mb-[10px] mt-[-50px]">
            You had successfully transfer to other WulaPal wallet, Thank you for your cooperation with us!
          </p>
          ...
          <a href="/wallet" className="mt-4 text-[#7C87AA] hover:underline">Back to <span className="font-semibold text-[#3A6953]">your Wallet</span></a>
        </div>
      )}
    </div>
  );

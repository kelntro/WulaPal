...
const DirectMessage = ({ userId: propUserId, fromModal = false }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#f4faf7] rounded-3xl overflow-hidden">
      {/* Messages Area */}
            ...
            <div key={idx} className={`flex ${isMe ? "justify-end" : "justify-start"} items-end`}>
              ...
              <div
                className={`relative max-w-[70%] ${
                  isMe ? "bg-gradient-to-br from-green-200 to-green-100" : "bg-white"
                } p-4 rounded-2xl shadow-md flex flex-col`}
              >
      ...
      <div className="px-6 py-4 border-t border-green-200 flex gap-3 bg-white items-center rounded-b-3xl shadow-inner">
        <label className="text-gray-400 cursor-pointer flex items-center">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-6 h-6 mr-2 hover:text-green-700 transition-colors"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M15.172 7.828a4 4 0 010 5.656l-4.95 4.95a3 3 0 01-4.243-4.243l7.071-7.071a2 2 0 112.828 2.828l-7.071 7.071"
            />
          </svg>
        ...
        />
        {file && (
          <span className="ml-2 text-green-600 font-medium truncate max-w-[120px]">
            {file.name}
          </span>
        )}
        <button
        ...
        >
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M3.75 21l16.5-9-16.5-9v7.5l13.5 1.5-13.5 1.5V21z"
            />
          </svg>
        </button>
      </div>
